...
import (
	...
	"github.com/gridworkz/kato/api/controller/upload"
...
func (a *AppStruct) ExportApp(w http.ResponseWriter, r *http.Request) {
	...
	case "POST":
		...
		// Update the database first and then notify the builder component
...
func (a *AppStruct) ImportApp(w http.ResponseWriter, r *http.Request) {
	...
	case "POST":
		...
		// Get the directory where the tar package is located
