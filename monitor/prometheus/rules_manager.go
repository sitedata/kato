				...
				&AlertingNameConfig{
					...
					Rules: []*RulesConfig{
						&RulesConfig{
							...
							Expr:        "kato_cluster_node_health != 0",
							For:         "3m",
							Labels:      commonLables,
						...
						&RulesConfig{
							...
							Expr:        "kato_cluster_component_health{component=\"KubeNodeReady\"} != 0",
							For:         "3m",
							Labels:      commonLables,
						...
						&RulesConfig{
							...
							Expr:        "kato_cluster_collector_duration_seconds > 10",
							For:         "3m",
							Labels:      commonLables,
...
func (a *AlertingRulesManager) InitRulesConfig() {
	_, err := os.Stat(a.config.AlertingRulesFile) //os.Stat to obtain file information
	if err != nil {
		if os.IsExist(err) {
			return
		}
